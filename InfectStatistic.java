...
class InfectStatistic {
		...
		{
			int i=proToInt(p);
			System.out.print("ip: ");System.out.print(ip[i]);System.out.print(" " );
			System.out.print("sp: ");System.out.print(sp[i]);System.out.print(" " );
			System.out.print("cure: ");System.out.print(cure[i]);System.out.print(" " );
			System.out.print("dead: ");System.out.print(dead[i]);System.out.print(" " );
			System.out.println(" ");
		}
			...
			for(File file:files)
			{
				...
				while((line=br.readLine())!=null)
				{
					if(line.matches(type1))
						{addIp(line);//System.out.println(line);
